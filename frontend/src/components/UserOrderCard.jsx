...
function UserOrderCard({ data }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 space-y-4">
      ...
      <div className="flex justify-between items-center border-t pt-2">
        {data.totalAmount === 0 ? (
          <span className="bg-green-100 text-green-700 text-sm px-3 mx-3 py-1 rounded-full font-semibold">
            Prepaid
          </span>
        ) : (
        ...
        <button
          className="bg-[#D40000] hover:bg-[#F60000] text-white px-4 py-2 rounded-lg text-sm"
