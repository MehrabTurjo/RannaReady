...
// FIX: Changed FaCalendarAlt to FaCalendarDays for FA6 compatibility
import {
  FaStore,
  FaLocationDot,
  FaUtensils,
  ...
  useEffect(() => {
    const handleShop = async () => {
      try {
        ...
        // 2. Fetch Weekly Menus (Ensure backend route exists)
        const menuRes = await axios.get(
          `${serverUrl}/api/weekly/menu/${shopId}`,
          { withCredentials: true }
        );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <h2 className="flex items-center justify-center gap-3 text-3xl font-bold mb-10 text-gray-800">
          <FaUtensils className="text-[#D40000]" /> Food Menu
        </h2>
