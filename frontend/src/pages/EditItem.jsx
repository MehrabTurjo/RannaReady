        ...
        <div className='min-h-screen bg-[#fff9f6] py-10 px-4 flex justify-center items-center'>
            ...
            <div className='max-w-xl w-full bg-white shadow-2xl rounded-2xl p-8 border border-gray-100 relative'>
                ...
                <div className='flex flex-col items-center mb-8 mt-4'>
                    ...
                    <p className='text-gray-500 mt-2 text-sm'>Update details for this dish</p>
                </div>
                ...
                <form className='space-y-6' onSubmit={handleSubmit}>
                        ...
                        >
                            {frontendImage ? (
                                ...
                                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p className="text-sm text-gray-500"><span className="font-semibold" style={{color: brandColor}}>Click to change</span> photo</p>
                                    <p className="text-xs text-gray-400">SVG, PNG, JPG or GIF</p>
                                </div>
                            )}
                            <input id="food-image-upload" type="file" accept='image/*' className="hidden" onChange={handleImage} />
                        </label>
                        {frontendImage && <p className='text-xs text-center text-gray-400 mt-2'>Click image to replace</p>}
                    </div>
                    ...
                    {/* Submit Button */}
                    <button 
                        className='w-full text-white font-bold py-3.5 rounded-xl shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 mt-6 flex justify-center items-center cursor-pointer'
